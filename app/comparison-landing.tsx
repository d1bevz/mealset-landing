...
import { PreviewFoodLogging } from './preview-food-logging';
import { Science } from './science';
import { Pricing } from './pricing';
import { copy, type Locale } from './copy';
import { previewCopy } from './comparison/preview-copy';
...
export function ComparisonLanding({ locale }: { locale: Locale }) {
  const d = {
    ...copy[locale],
    ...previewCopy[locale],
  };
  return (
    <>
      ...
      <header className="site-header">
        <a
          href={pagePath(locale === 'ru' ? '/preview' : '/en/preview')}
          aria-label={d.home}
        >
          <Wordmark />
        </a>
        ...
        >
          ...
          <a href="#pricing">{locale === 'ru' ? 'Подписка' : 'Membership'}</a>
        </nav>
      ...
      <main id="main">
        <section
          className="hero preview-value-hero"
        ...
        <PreviewFoodLogging locale={locale} />
