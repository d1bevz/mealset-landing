              ...
              <dl className="food-demo-macros">
                {d.macroLabels.map((label, i) => (
                  <div key={label}>
                    <dt>{label}</dt>
                    <dd>
                      {number(method.nutrition[i + 1])} <span>{d.grams}</span>
                    </dd>
                  </div>
                ))}
              </dl>
