...
Лендинг ИИ-нутрициолога Саши в Telegram. Основной вариант RU/EN показывает
готовые примеры переписки с возможностью продолжения, пользу накопленного
контекста, подход Саши, тарифы Telegram Stars и FAQ. Диалоги иллюстративные,
реальные скриншоты Telegram пока не добавлены. Второй вариант сохранён отдельно.
...
1500 Telegram Stars в месяц (обновлено по правке цены от 20.09.2026).
Ориентир покупки звёзд: ≈ 3200 ₽ (RU) и ≈ €33 (EN). Проверено 20.09.2026:
[App Store RU](https://apps.apple.com/ru/app/telegram-messenger/id686449807)
показывает 1060 ₽ за 500 Stars (три пакета = 3180 ₽ ≈ 3200 ₽),
[App Store PT](https://apps.apple.com/pt/app/telegram-messenger/id686449807)
— €21,99 за 1000 Stars и €10,99 за 500 Stars (всего €32,98 ≈ €33).
Это приблизительная стоимость покупки звёзд,
...
- `app/primary-demo-copy.ts` — шесть сценариев RU/EN: калории, память,
  рекомендации, план, покупки и инициатива Саши. Источники расчётов и границы адаптации —
  в `docs/demo-provenance.md`. Действия в демонстрации не меняют данные бота.
- `app/globals.css`, `app/copy.ts` — общие стили и базовые тексты RU/EN.
